...
class RewardModel:
    ...
    def __init__(self, #✅
            ...
            mb_size = 5,      # mini-batch size used during ablation. ✅#
...
# 
            ...
            try:
                with open(file_path, "r") as f:
                    ...
                    for line in f:
                        ...
                        self.obses.append(data["imageobs"])
    ...
    def save(self, model_dir="pretrain/reward_model/dqn", save_step=None): # ✅
